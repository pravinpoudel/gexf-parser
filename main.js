(()=>{
	...
	let gexf_file = fs.readFileSync('./files/revo_run0.gexf', 'utf-8');
	...
	fs.readFile(path.join(__dirname,"./mygraph.json"), 'utf8', (err, data)=>{
		if(err){
			console.error(err);
		}
		else{
			fs.writeFile("mygraph.json", graph_json, 'utf8', ()=>{console.log("please check the json file")});
		}
	})
})()